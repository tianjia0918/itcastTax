        ...
        <td width="331" align="right" valign="top">
            <table width="350" border="0" cellpadding="0" cellspacing="0">
                ...
                <tr>
                    ...
                    <td align="left" valign="middle" ><a href="${ctx}/sys/login_LoginOut.action">退出</a></td>
                </tr>
            </table>
        </td>
    </tr>
...
<div class="menu">
    <ul class="clearfix">
        ...
        <li><a href="${ctx}/nsfw/nsfwHome_frame.action">纳税服务</a> </li>
    ...
    <div class="right">
        <div class="left_grzx1">
            ...
            <table width="98%" border="0" align="center">
                 ...
                 <s:iterator value="infoList" status="il">
                   
                            <tr <s:if test="#il.odd">bgcolor="f8f8f8"</s:if> > 
                                <td align="center" width="180px"><s:property value="title"/></td>
                                <td align="center" width="180px"><s:property value="#infoTypeMap[type]"/></td>
                                <td align="center" width="180px"><s:property value="creator"/></td>
                                <td align="center" width="180px"><s:date name="createTime"  nice="false"/></td>
                            </tr>
                 </s:iterator>
        ...
        <div class="lc_grzx1">
            <div class="lc_grzxbt">
                ...
                <div style="float:right;padding-top:3px;">
                	 <h1><a href="${ctx}/sys/home_complainAddUI.action" target="_blank">我要投诉</a></h1>
                </div>
            </div>
            <table width="98%" border="0" align="center">
                   <s:iterator value="complainList" status="cl">
                   
                            <tr <s:if test="#cl.odd">bgcolor="f8f8f8"</s:if> > 
                                <td align="center" width="180px"><s:property value="compTitle"/></td>
                                <td align="center" width="180px"><s:property value="#complainStateMap[state]"/></td>
                                <td align="center" width="180px"><s:property value="compIsNm==true?'匿名投诉':'非匿名投诉'"/></td>
                                <td align="center" width="180px"><s:date name="compTime"  nice="false"/></td>
                            </tr>
                        </s:iterator>
            <!--     <tr>
                    <td height="23">
