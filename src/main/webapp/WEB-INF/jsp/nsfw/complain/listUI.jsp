...
<head>
    ...
    <script type="text/javascript">
  	...
  	function doAnnualStatistic(){
  	    document.forms[0].action = "${basePath}nsfw/complain_getAnnualStatisticData.action";
  		document.forms[0].submit();
...
<form name="form1" action="" method="post">
    <div class="p_d_1">
                    ...
                    <table width="100%" border="0">
                       ...
                       <s:iterator value="pageResult.resultList" status="st">
                            <tr <s:if test="#st.odd"> bgcolor="f8f8f8" </s:if> >
                                ...
                                <td align="center"><s:property value="becompDept"/></td>
                                <td align="center"><s:property value="becompName"/></td>
        ...
        <jsp:include page="/WEB-INF/jsp/pageNum.jsp"/>
