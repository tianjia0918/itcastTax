...
<form id="form" name="form" action="${basePath }nsfw/complain_deal.action" method="post" enctype="multipart/form-data">
    ...
    <table id="baseInfo" width="100%" align="center" class="list" border="0" cellpadding="0" cellspacing="0"  >
        ...
        <tr>
            ...
            <td><s:property value="complain.compIsNm?'匿名投诉':'非匿名投诉'"/></td>
        </tr>
        <tr>
            <td class="tdBg">投诉人单位：</td>
            <td>
            <s:if test="!complain.compIsNm">
        ...
        <tr>
            ...
            <td><s:if test="!complain.compIsNm"><s:property value="complain.compName"/></s:if></td>
        </tr>
        <tr>
            ...
            <td>
	            ...
	            <s:elseif test="%{complain.compPhone.length() > 10}">
        ...
        <tr>
            ...
            <td><s:property value="complain.becompDept"/></td>
        </tr>
        <tr>
            <td class="tdBg">被投诉人：</td>
            <td><s:property value="complain.becompName"/></td>
        </tr>
        <tr>
