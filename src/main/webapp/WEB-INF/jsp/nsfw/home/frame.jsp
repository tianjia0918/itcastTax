...
<frameset cols="*,1222,*" class="bj" frameborder="no" border="0" framespacing="0">
    ...
    <frameset rows="156,*" cols="*" frameborder="no" border="0" framespacing="0">
        <frame src="${basePath}nsfw/nsfwHome_top.action" name="topFrame" scrolling="No" noresize="noresize" id="topFrame" />
        <frameset cols="14%,60%" frameborder="no" border="0" framespacing="0">
            <frame src="${basePath}nsfw/nsfwHome_left.action" scrolling="yes" noresize="noresize" id="leftFrame" />
