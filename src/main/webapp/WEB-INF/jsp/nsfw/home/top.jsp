...
<body>
			...
			<td width="300" align="right" valign="top">
				<table width="350" border="0" cellpadding="0" cellspacing="0">
					...
					<tr>
					    <td align="center"></td>
                        <td align="left"></td>
                        <td align="left"><a><b></b><font color="red">欢迎您，<s:property value="#session.SYS_USER.account"/></font></a></td>
	...
	<div class="banner">
		<div class="menu">
			<ul class="clearfix">
				<li><a href="${basePath}sys/home_execute.action" target="_top">工作主页</a></li>
                <li><a href="javascript:void(0);">行政管理</a></li>
                <li><a href="javascript:void(0);">后勤服务</a></li>
                <li><a href="javascript:void(0);">在线学习</a></li>
                <li><a href="${basePath}nsfw/nsfwHome_frame.action">纳税服务</a></li>
