...
<head>
    ...
    <script type="text/javascript">
         function doSubmit(){
             document.forms[0].action = "${basePath}nsfw/user_add.action";
             document.forms[0].submit();
         }

    </script>
  
  <script type="text/javascript" src="${basePath}js/validation/emailValidation.js"></script>    
  <script type="text/javascript" src="${basePath}js/validation/phoneValidation.js"></script>
    ...
    <script type="text/javascript">
        ...
        if(account!=null&&account!=""){
          $.ajax({
	            ...
	            url: "${basePath}nsfw/user_vertifyAccount.action",
...
<form id="form" name="form" action="${basePath}nsfw/usedoVertifyr_add.action" method="post" enctype="multipart/form-data">
    <div class="p_d_1">
        <div class="p_d_1_1">
    ...
    <table id="baseInfo" width="100%" align="center" class="list" border="0" cellpadding="0" cellspacing="0"  >
        ...
        <tr>
            ...
            <td><s:textfield id="account" name="user.account" onchange="doVertify()"/></td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td><s:textfield id="email" name="user.email" onchange="validationEmail()"/></td>
        </tr>
        <tr>
            <td class="tdBg" width="200px">手机号：</td>
            <td><s:textfield name="user.mobile" id="phone" onchange="validationPhone()"/></td>
        </tr>
        <tr>
