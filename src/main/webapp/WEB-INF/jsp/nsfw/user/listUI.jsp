    ...
    <script type="text/javascript">
		...
		function doSelectAll(){
      	...
      	function doImport(){
      	 ...
      	 var path="${basePath}nsfw/user_listUI.action";
...
<form name="form1" action="" method="post" enctype="multipart/forforms[0].m-data">
    <div class="p_d_1">
        <div class="p_d_1_1">
...
<s:hidden><s:property value="user.name"/></s:hidden>
</body>
</html>