...
<head>
    ...
    <script type="text/javascript">
         function doSubmit(){
             document.forms[0].action = "${basePath}nsfw/user_edit.action";
...
<form id="form" name="form" action="${basePath }nsfw/user_edit.action" method="post" enctype="multipart/form-data">
    ...
    <table id="baseInfo" width="100%" align="center" class="list" border="0" cellpadding="0" cellspacing="0"  >
        ...
        <tr>
            ...
            <td>
                 <s:if test="%{user.headImg != null && user.headImg != ''}">
                    <img src="${basePath}fileUpload/<s:property value='user.headImg'/>" width="100" height="100"/>
                </s:if>
        ...
        <tr>
            ...
            <td><s:textfield name="user.email" id="email" onchange="validationEmail()"/></td>
        </tr>
        <tr>
